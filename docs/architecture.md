...
Tres bases separadas con roles distintos ([ADR-003](./adr/003-separacion-bases-logicas.md)):

- `academic_main` — dominio académico, evaluación, contenido, analítica
- `ctr_store` — eventos del CTR y clasificaciones
- `identity_store` — mapping pseudónimo → identidad real
