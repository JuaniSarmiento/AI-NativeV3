...
- **Total de reglas**: 138
- **Distribución por fase**: F0 (9) · F1 (13) · F2 (11) · F3 (28) · F4 (9) · F5 (15) · F6 (13) · F7 (9) · F8 (7) · F9 (7) · Transversales agrupadas (17 referencias cruzadas).
- **Distribución por severidad**: Críticas 38 · Altas 56 · Medias 34 · Bajas 10.
- **Distribución por categoría**: Invariante 24 · Cálculo 18 · Validación 17 · Autorización 9 · Persistencia 12 · Privacidad 8 · Operación 18 · Auditoría 14 · Seguridad 18.
...
### RN-018 — Casbin DEBE cargar 65 policies para la matriz 4 roles × 17 recursos
**Categoría**: Autorización
**Fase origen**: F1
**Servicio(s)**: academic-service
**Severidad**: Alta

**Regla**: El seed `seed-casbin` carga exactamente 65 policies que cubren las acciones permitidas para los 4 roles (`estudiante`, `docente`, `docente_admin`, `superadmin`) sobre 17 recursos del dominio. El seed es idempotente (`DELETE + INSERT` en una sola transacción).

**Justificación**: Matriz explícita, testeada con `test_casbin_matrix.py` (23 tests parametrizados). Agregar un recurso sin actualizar la matriz deja gaps de autorización.

**Verificación**: `apps/academic-service/src/academic_service/seeds/casbin_policies.py`; `apps/academic-service/tests/integration/test_casbin_matrix.py`.
...
- **⚠ Verificar RN-018** — "65 policies" viene de F1-STATE.md; confirmar contando filas en `apps/academic-service/src/academic_service/seeds/casbin_policies.py`.
