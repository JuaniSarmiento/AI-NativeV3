...
- `docs/adr/` — ADRs numerados (`ls docs/adr/` para el catálogo actual; al cierre de iter 2 son 31 ADRs, +1 con ADR-032 redactado en `closing-adrs-and-frontend-polish`). Cada ADR justifica una decisión atada a tests. Los más recientes que rigen modelos/invariantes descritos abajo:
