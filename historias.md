...
**Historia**:
Como superadmin, quiero cargar 65 policies Casbin iniciales que cubran cuatro roles (estudiante, docente, docente_admin, superadmin) por diecisiete recursos, para que la autorización quede completamente declarada antes del primer login.

**Criterios de aceptación**:
- `make seed-casbin` deja 65 filas en `casbin_rule` sin duplicados.
...
- Existe test matriz que recorre las 65 policies seedadas.
...
| HU-016 | F1 | academic-service | test matriz 65 policies |
